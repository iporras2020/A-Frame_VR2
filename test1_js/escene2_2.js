...
AFRAME.registerComponent('basic-scene2', {
    ...
    init: function() {
        ...
        sphere.setAttribute('position', {x:1, y: 1.25, z: -5});
        ...
        cylinder.setAttribute('position', {x:2, y: 0.75, z: -3});
        ...
        plane.setAttribute('position', {x:3, y: 0, z: -4});
